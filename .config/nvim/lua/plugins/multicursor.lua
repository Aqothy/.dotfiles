...
return {
    ...
    keys = {
        ...
        { "<down>", mc("lineAddCursor", "line", 1), desc = "Add line below cursor" },
        { "<up>", mc("lineAddCursor", "line", -1),  desc = "Add line above cursor" },
        ...
        { "g=", mc("alignCursors"), desc = "Align cursor columns" },
        ...
        { "<a-leftmouse>", mc("handleMouse"), desc = "Cursor at mouse click" },
    },
    config = function()
