...
return {
    ...
    keys = {
        ...
        { "<down>", mc("lineAddCursor", "line", 1), mode = "n", desc = "Add line below cursor" },
        { "<up>", mc("lineAddCursor", "line", -1), mode = "n",  desc = "Add line above cursor" },
        { "gA", mc("addCursorOperator", "line"), mode = { "n", "x" }, desc = "Add cursor for each line in range" },
        { "s", mc("splitCursors", "match"), mode = "x", desc = "Split visual selections by regex" },
        { "g=", mc("alignCursors"), mode = "n", desc = "Align cursor columns" },
        { "ga", mc("matchAllAddCursors"), mode = { "n", "x" }, desc = "Match all add cursors" },
