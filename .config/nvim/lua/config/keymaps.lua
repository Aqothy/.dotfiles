...
map("n", "<M-s-up>", "3<C-W>+", { desc = "Resize window up" })
map("n", "<M-s-down>", "3<C-W>-", { desc = "Resize window down" })
...
map("x", "<M-down>", ":<C-u>execute \"'<,'>move '>+\" . v:count1<cr>gv=gv", { desc = "Move Down" })
map("x", "<M-up>", ":<C-u>execute \"'<,'>move '<-\" . (v:count1 + 1)<cr>gv=gv", { desc = "Move Up" })
